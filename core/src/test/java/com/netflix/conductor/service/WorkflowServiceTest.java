...
public class WorkflowServiceTest {
  ...
  public void testGetWorklfowsMultipleCorrelationId() {
    ...
    when(executionService.getWorkflowInstances(
            anyString(), anyString(), anyBoolean(), anyBoolean()))
        .thenReturn(workflowArrayList);
    assertEquals(workflowMap, workflowService.getWorkflows("test", true, true, correlationIdList));
  }
  ...
  public void testSearchWorkflows() {
    ...
    assertEquals(
        searchResult,
        workflowService.searchWorkflows(0, 100, Collections.singletonList("asc"), "*", "*"));
  }
  ...
  public void testSearchWorkflowsV2() {
    ...
    assertEquals(
        searchResult,
        workflowService.searchWorkflowsV2(0, 100, Collections.singletonList("asc"), "*", "*"));
  }
  ...
  public void testSearchWorkflowsByTasks() {
    ...
    when(executionService.searchWorkflowByTasks("*", "*", 0, 100, Collections.singletonList("asc")))
        .thenReturn(searchResult);
    assertEquals(searchResult, workflowService.searchWorkflowsByTasks(0, 100, "asc", "*", "*"));
    assertEquals(
        searchResult,
        workflowService.searchWorkflowsByTasks(0, 100, Collections.singletonList("asc"), "*", "*"));
  }
