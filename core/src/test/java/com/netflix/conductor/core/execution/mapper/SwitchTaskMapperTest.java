...
@ContextConfiguration(
    classes = {TestObjectMapperConfiguration.class, SwitchTaskMapperTest.TestConfiguration.class})
...
public class SwitchTaskMapperTest {
  ...
  public void getMappedTasks() {
    ...
    Map<String, Object> input =
        parametersUtils.getTaskInput(switchTask.getInputParameters(), workflowModel, null, null);
