...
public class TestDefaultEventProcessor {
  ...
  public void testEventProcessor() {
    ...
    startWorkflowInput.setCorrelationId(startWorkflowAction.getStart_workflow().getCorrelationId());
    ...
    doAnswer(
        ...
        .execute(
            argThat(
                argument ->
                    startWorkflowAction.getStart_workflow().getName().equals(argument.getName())
                        && startWorkflowAction
                            .getStart_workflow()
                            .getVersion()
