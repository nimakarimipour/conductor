...
@ContextConfiguration(
    classes = {TestObjectMapperConfiguration.class, TestDeciderOutcomes.TestConfiguration.class})
...
public class TestDeciderOutcomes {
  ...
  public void testOptional() {
    ...
    assertEquals(1, outcome.tasksToBeScheduled.size());
    assertEquals(
        task1.getTaskReferenceName(), outcome.tasksToBeScheduled.get(0).getReferenceTaskName());
    ...
    assertEquals(task1Id, outcome.tasksToBeUpdated.get(0).getTaskId());
    assertEquals(
        task2.getTaskReferenceName(), outcome.tasksToBeScheduled.get(0).getReferenceTaskName());
  }
  ...
  public void testOptionalWithDynamicFork() {
    ...
    for (int i = 0; i < 3; i++) {
      assertEquals(
          TaskModel.Status.COMPLETED_WITH_ERRORS, outcome.tasksToBeUpdated.get(i).getStatus());
    ...
    assertEquals(
        TaskModel.Status.COMPLETED_WITH_ERRORS, outcome.tasksToBeScheduled.get(0).getStatus());
  }
  ...
  public void testDecisionCases() {
    ...
    assertEquals(
        decide.getTaskReferenceName(), outcome.tasksToBeScheduled.get(0).getReferenceTaskName());
    assertEquals(
