...
public class TestWorkflowSweeper {
  ...
  public void testPostponeDurationForWaitTaskType() {
    ...
    verify(queueDAO)
        .setUnackTimeout(
            DECIDER_QUEUE, workflowModel.getWorkflowId(), defaultPostPoneOffSetSeconds * 1000);
  }
  ...
  public void testPostponeDurationForWaitTaskTypeWithWaitTime() {
    ...
    workflowSweeper.unack(workflowModel, defaultPostPoneOffSetSeconds);
    verify(queueDAO)
        .setUnackTimeout(DECIDER_QUEUE, workflowModel.getWorkflowId(), (waitTimeout + 1) * 1000);
  }
  ...
  public void testPostponeDurationForTaskInScheduledWithPollTimeoutSet() {
    ...
    workflowSweeper.unack(workflowModel, defaultPostPoneOffSetSeconds);
    verify(queueDAO)
        .setUnackTimeout(DECIDER_QUEUE, workflowModel.getWorkflowId(), (pollTimeout + 1) * 1000);
  }
