...
public interface QueueDAO {
   ...
   * for further polls until specified duration. By default, the message is removed and pushed
   * backed with postponeDurationInSeconds to be backwards compatible.
   *
   * @param queueName name of the queue
   * @param messageId message id
   * @param priority message priority (between 0 and 99)
