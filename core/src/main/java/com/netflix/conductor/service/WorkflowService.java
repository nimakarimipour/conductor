...
public interface WorkflowService {
  ...
  void terminateWorkflow(
      @NotEmpty(message = "WorkflowId cannot be null or empty.") String workflowId, String reason);
  ...
  SearchResult<WorkflowSummary> searchWorkflows(
      ...
      @Max(
              value = 5_000,
              message = "Cannot return more than {value} workflows. Please use pagination.")
          int size,
      String sort,
      String freeText,
      String query);
