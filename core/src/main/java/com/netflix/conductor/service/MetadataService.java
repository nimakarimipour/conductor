...
public interface MetadataService {
     ...
     */
    BulkResponse updateWorkflowDef(@NotNull(message = "WorkflowDef list name cannot be null or empty") @Size(min = 1, message = "WorkflowDefList is empty") List<@NotNull(message = "WorkflowDef cannot be null") @Valid WorkflowDef> workflowDefList);
     ...
     */
    WorkflowDef getWorkflowDef(@NotEmpty(message = "Workflow name cannot be null or empty") String name, @Nullable Integer version);
