...
public class WorkflowExecutor {
     ...
     *     termination
     */
    public WorkflowModel terminateWorkflow(WorkflowModel workflow, @Nullable String reason, @Nullable String failureWorkflow) {
        try {
     ...
     */
    @Nullable
    public WorkflowModel decide(@Nullable String workflowId) {
