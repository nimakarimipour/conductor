...
public class SwitchTaskMapper implements TaskMapper {
   ...
   *       <li>List of tasks based on the evaluation of {@link WorkflowTask#getEvaluatorType()} and
   *           {@link WorkflowTask#getExpression()} are scheduled.
   *       <li>In the case of no matching {@link WorkflowTask#getEvaluatorType()}, workflow will be
   *           terminated with error message. In case of no matching result after the evaluation of
   *           the {@link WorkflowTask#getExpression()}, the {@link WorkflowTask#getDefaultCase()}
   *           Tasks are scheduled.
   *     </ul>
   */
  @Override
