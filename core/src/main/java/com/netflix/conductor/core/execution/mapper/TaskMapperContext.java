...
public class TaskMapperContext {
  ...
  @Nullable private final DeciderService deciderService;
  ...
  public static final class Builder {
    ...
    /**
     * Sets the {@code workflowModel} and returns a reference to this Builder so that the methods
    ...
    /**
     * Sets the {@code taskDefinition} and returns a reference to this Builder so that the methods
     * can be chained together.
     *
    ...
    /**
     * Sets the {@code workflowTask} and returns a reference to this Builder so that the methods can
     * be chained together.
     *
    ...
    /**
     * Sets the {@code taskInput} and returns a reference to this Builder so that the methods can be
     * chained together.
     *
    ...
    /**
     * Sets the {@code retryCount} and returns a reference to this Builder so that the methods can
     * be chained together.
     *
    ...
    /**
     * Sets the {@code retryTaskId} and returns a reference to this Builder so that the methods can
     * be chained together.
     *
    ...
    /**
     * Sets the {@code taskId} and returns a reference to this Builder so that the methods can be
     * chained together.
     *
    ...
    /**
     * Sets the {@code deciderService} and returns a reference to this Builder so that the methods
     * can be chained together.
     *
