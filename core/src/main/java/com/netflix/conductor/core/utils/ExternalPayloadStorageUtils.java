...
public class ExternalPayloadStorageUtils {
   ...
   * @throws TerminateWorkflowException if the payload size is bigger than permissible limit as per
   *     {@link ConductorProperties}
   */
  ...
  String uploadHelper(
    ...
    ExternalStorageLocation location =
        externalPayloadStorage.getLocation(ExternalPayloadStorage.Operation.WRITE, payloadType, "");
