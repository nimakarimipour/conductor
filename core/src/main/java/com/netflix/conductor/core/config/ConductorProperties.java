...
public class ConductorProperties {
  ...
  /**
   * The duration of workflow execution which qualifies a workflow as a short-running workflow when
   * async indexing to elasticsearch is enabled.
   */
  @DurationUnit(ChronoUnit.SECONDS)
  ...
  /**
   * The threshold of the workflow input payload size in KB beyond which the payload will be stored
  ...
  /**
   * The threshold of the workflow output payload size in KB beyond which the payload will be stored
   * in {@link com.netflix.conductor.common.utils.ExternalPayloadStorage}.
   */
  @DataSizeUnit(DataUnit.KILOBYTES)
  ...
  /**
   * The maximum threshold of the task input payload size in KB beyond which the task input will be
  ...
  /**
   * The threshold of the task output payload size in KB beyond which the payload will be stored in
   * {@link com.netflix.conductor.common.utils.ExternalPayloadStorage}.
   */
  @DataSizeUnit(DataUnit.KILOBYTES)
  ...
  /**
   * The maximum threshold of the task output payload size in KB beyond which the task input will be
   * rejected and the task will be marked as FAILED_WITH_TERMINAL_ERROR.
   */
  @DataSizeUnit(DataUnit.KILOBYTES)
