...
public class DynamicTaskMapper implements TaskMapper {
   ...
   *
   * @param taskInput: a map which contains different input parameters and also contains the mapping
   *     between the dynamic task name param and the actual name representing the dynamic task
   ...
   *
   * @param workflowTask: An instance of {@link WorkflowTask} which has the name of the using which
   *     the {@link TaskDef} can be retrieved.
