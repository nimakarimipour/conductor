...
public class JoinTaskMapper implements TaskMapper {
  ...
  /**
   * This method maps {@link TaskMapper} to map a {@link WorkflowTask} of type {@link TaskType#JOIN}
   * to a {@link TaskModel} of type {@link TaskType#JOIN} with a status of {@link
